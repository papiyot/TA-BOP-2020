...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Input Data Departemen Jasa</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <li class="breadcrumb-item active">Data Departemen jasa</li>
      </ol>
  </div><!-- /.col -->
</div><!-- /.row -->
</div><!-- /.container-fluid -->
  ...
  <form method="post" action="{{ route('detail_dep.store') }}" id="myForm" >
    ...
    <div class="card card-default">
      <div class="card-header">
        <h3 class="card-title">Input Data Departemen Jasa</h3>
      ...
      <div class=" card-body">
        ...
        <p class="card-text text-center" >Silahkan inputkan Data Departemen jasa.</p>
    ...
    <div class="text-center">
      ...
      <a  href="{{url('/detaildepar/createPro')}}" class="btn btn-secondary btn-sm">selanjutnya</a>
    </div>
  </div>
  <!-- /.card-body -->
</div>
