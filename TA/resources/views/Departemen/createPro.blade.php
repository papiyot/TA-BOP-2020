...
<div class="card-body">
  ...
  <form method="post" action="{{ route('dep.store') }}" id="myForm">
    ...
    <div class="card card-default">
      ...
      <div class=" card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="jenis_dp" value="Produksi" readonly="">
        </div>
        <div class="form-group">
    ...
    <a  href="{{ route('dasar.create')}}" class="btn btn-secondary btn-sm btn-block">selanjutnya</a>
  </div>
  <!-- /.card-body -->
</div>
</form>
