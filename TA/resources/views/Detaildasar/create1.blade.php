...
<div class="justify-content-center">
	<div class="card ">
		...
		<div class="card-body">
			...
			<p class="card-text text-center">Silakan Isikan data <strong> Departemen Jasa</strong>, Isikan juga Kos Awal dan Dasar Pembebanannya.  </p>
	...
	<div class="text-center">
		...
		<a  href="{{ url('Detaildasar/createPro') }}" class="btn btn-secondary btn-sm">selanjutnya</a>
	</div>
</div>
